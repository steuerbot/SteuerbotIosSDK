...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SwiftFramework",
            url: "https://steuerbot-app-artifacts-nonprod.s3.eu-central-1.amazonaws.com/ios/2.13.0-rc.3/SwiftFramework.xcframework.zip",
            checksum: "a3f8c22db476bcacb40150b945801894cac61350511e333def378490a82d391f"
        ),
        .binaryTarget(
            name: "hermes",
