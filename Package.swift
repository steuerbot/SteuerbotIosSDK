...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SwiftFramework",
            url: "https://steuerbot-app-artifacts-nonprod.s3.eu-central-1.amazonaws.com/sdk/ios/v1.0.2/SwiftFramework.xcframework.zip",
            checksum: "17395b30a9edbd593aeef1770ad532a9b9fba2072bc35e64dc051adb49a3e090"
        ),
        .binaryTarget(
            name: "hermes",
