...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SwiftFramework",
            url: "https://steuerbot-app-artifacts-nonprod.s3.eu-central-1.amazonaws.com/ios/2.13.0-rc.2/SwiftFramework.xcframework.zip",
            checksum: "377d27127721fb17da8fb45fa8fbd144cda3a86272d0ebdc424378d86d1fffe9"
        ),
        .binaryTarget(
            name: "hermes",
