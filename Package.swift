...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SwiftFramework",
            url: "https://steuerbot-app-artifacts-nonprod.s3.eu-central-1.amazonaws.com/sdk/ios/1.0.5/SwiftFramework.xcframework.zip",
            checksum: "c9c776411380e803ce1a7666506d972fa68f8e4f057c53052b74a6a1c969d2f3"
        ),
        .binaryTarget(
            name: "hermes",
