...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SwiftFramework",
            url: "https://steuerbot-app-artifacts-nonprod.s3.eu-central-1.amazonaws.com/sdk/ios/1.0.4/SwiftFramework.xcframework.zip",
            checksum: "de9eeb4edca6125274f57c4dc77f44d6b897a774e55349cc22fc762db92dd892"
        ),
        .binaryTarget(
            name: "hermes",
